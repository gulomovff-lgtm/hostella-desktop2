// Styles
export const inputClass = "w-full px-4 py-3 bg-white border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all text-sm shadow-sm font-medium text-slate-700 no-spinner";
export const labelClass = "block text-xs font-bold text-slate-500 mb-2 uppercase tracking-wide ml-1";

// Telegram Config
export const TG_BOT_TOKEN = "8483864240:AAGotoLWbAVH4iA6gh3GF-eNL5fAASHW468";
export const TG_CHAT_IDS = ["7029598539", "6953132612"];
